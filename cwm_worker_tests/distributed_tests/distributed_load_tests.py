    ...
    def dump_stats():
        ...
        for endpoint, row in normalized_stats.items():
            ...
            output_row = {
                'endpoint': endpoint,
                'datacenter': {
                    'http://cwm-worker-cluster-eu-load-test-1.uumpa.xyz': 'EU',
                    'https://cwm-worker-cluster-eu-load-test-1.uumpa.xyz': 'EU',
                    'http://cwm-worker-cluster-eu-load-test-2.uumpa.xyz': 'IL',
                    'https://cwm-worker-cluster-eu-load-test-2.uumpa.xyz': 'IL',
                    'http://cwm-worker-cluster-eu-load-test-3.uumpa.xyz': 'CA-TR',
                    'https://cwm-worker-cluster-eu-load-test-3.uumpa.xyz': 'CA-TR',
                    'http://cwm-worker-cluster-eu-load-test-4.uumpa.xyz': 'EU-LO',
                    'https://cwm-worker-cluster-eu-load-test-4.uumpa.xyz': 'EU-LO',
