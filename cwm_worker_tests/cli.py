...
@click.option('--bucket', required=False, type=str, help='Bucket name to upload to and download from. If not provided, will use autogenerated bucket name based on timestamp')
@click.option('--num-files', required=True, type=int, help='Number of files to upload/download')
@click.option('--file-size', required=True, type=int, help='Each file size in bytes')
